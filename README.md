...
(относительно) простой скрипт, работающий с программами LeadFinder (v.2012 b.1) и BuildModel (v.2004 b.1), позволяющий запускать множественные процессы докирования и обеспечивающий удобный ввод и вывод значений
